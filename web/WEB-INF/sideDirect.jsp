...
<!DOCTYPE html>   
     ...
     <div class="contenedor-menu">
            ...
            <ul class="menu">
                    ...
                    <li>
                        <a href="#"><i class="icono izquierda fas fa-book"></i>Solitud<i class="icono derecha fa fa-caret-down"></i></a>
                         <ul>
                            <li><a href="#"id="cargar-solicitudes">Registrar Solicitud</a></li>
                         </ul>
                    </li>
                    <li>
                        <a href="#"><i class="icono izquierda fas fa-bell"></i>Notificaciones<i class="icono derecha "></i></a>
                        <ul>
